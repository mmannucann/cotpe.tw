...
var llAnimWrap, llAnim, base = window.base || {},
    ...
    update100vh = (base.getPageY = function() {
        ...
        $(window).on("scroll resize orientationchange load touchmove", t), setTimeout(t, 31), setTimeout(t, 300);
        var i, a = $("html"),
            r = a.hasClass("header--fixed"),
            s = 0;

        function t() {
            var t, e = base.getPageY(),
                n = base.getWinH(),
                o = a.outerHeight() - n - 60;
            r || (t = "header--fixed", 100 <= e && !a.hasClass(t) ? a.addClass(t) : e < 100 && a.hasClass(t) && a.removeClass(t)), t = "leave-top", i = .3 * n <= e ? (a.addClass(t, .3 * n <= e), 20) : (a.removeClass(t, .3 * n <= e), 6), base.ignoreScrolled || (e < s - i || e <= 0 ? a.addClass("scrolled-up").removeClass("scrolled-down") : .3 * n <= e && s + .5 * i < e && a.addClass("scrolled-down").removeClass("scrolled-up"), s = e), t = "reach-bottom", o <= e && !a.hasClass(t) ? a.addClass(t) : e < o && a.hasClass(t) && a.removeClass(t)
        }
        setTimeout(function() {
